...
m_av           = m_GNC*(1+MGA_GNC) + m_data_hand + m_Com*(1+MGA_com)
...
Ve        = Isp*g
TWR       = 1.5
Mass_caps = m_EPS*(1+MGAEPS) + m_Life_support*(1+MGA_ls) + m_av*(1+MGAav) + m_cabin*(1+MGA_cab) + m_pl + m_payl_cont + M_TPS*(1+MGATPS)
DV1       = 2200*f
DV2       = 3200*f 
