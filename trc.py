...
comp = tc.param(name="Complexity",weight=0.28913,direc="LB")
lov = tc.param(name="LOV Risk",weight=0.285,direc="LB")
lom = tc.param(name="LOM Risk",weight=0.015,direc="LB")
...
#d4_in_list = [dmb.Mass_conc(DV1,DV2,410,"SE")[0][0],dmb.Mass_conc(DV1,DV2,410,"SE")[0][1],4,c4.comp(),1/82.3690,1/280.0512]
