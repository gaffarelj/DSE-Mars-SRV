...
def comp():
    ...
    launch_abort.add_c(structural, [capsule_struc, vehicle_struc])
    batteries.add_c(structural,capsule_struc)
    batteries.add_c(power,pcdu)
    fuel_cells.add_c(structural,capsule_struc)
    fuel_cells.add_c(power,pcdu)
    oxygentanks.add_c(structural,capsule_struc)
    oxygentanks.add_c(flow,atmos)
    atmos.add_c(data,heater)
    sensors.add_c(data,gn_comp)
    gn_comp.add_c(data,[deceleration_system, launch_abort, f_comp, landing_legs, feedsystem, actuator_feedsystem])
    ...
    hydraulics.add_c(hydra,[control_actuators, feedsystem, chamber, landing_legs])
