...
l = [locking_mechanism,hatch,deceleration_system,gn_comp,sensors,launch_abort,bio_monitoring,f_comp,enc_dec,amplifiers,receving_ant,transmitting,batteries,fuel_cells,pcdu,heater,atmos,oxygentanks,cargo_compartment,
    heat_shield,cooling_system,actuator_tanks,actuator_feedsystem,control_actuators,tanks,hydraulics,chamber,feedsystem,pressurization,landing_gears,vehcile_struc,wing,control_surfaces]

locking_mechanism.add_c(structural,vehcile_struc)
hatch.add_c(structural,vehcile_struc)
deceleration_system.add_c(structural,vehcile_struc)
launch_abort.add_c(structural,vehcile_struc)
batteries.add_c(structural,vehcile_struc)
batteries.add_c(power,pcdu)
fuel_cells.add_c(structural,vehcile_struc)
fuel_cells.add_c(power,pcdu)
oxygentanks.add_c(structural,vehcile_struc)
...
gn_comp.add_c(data,landing_gears)
...
hydraulics.add_c(hydra,landing_gears)
pressurization.add_c(flow,feedsystem)
feedsystem.add_c(flow,chamber)
chamber.add_c(structural,wing)
landing_gears.add_c(structural,vehcile_struc)
wing.add_c(structural,vehcile_struc)
wing.add_c(structural,control_surfaces)
