...
#plot
plt.plot(V,h_eq_glide,color="royalblue",label="skipping flight constraint")
plt.plot(V,h_g,color="red",label="g-load constraint")
#plt.plot(V_400,h_400,"r+")
plt.plot(velocity, height,"--",color="lime",label="re-entry flight envelope: periapsis=3089 km")
plt.grid(color="gainsboro")
plt.ylim(bottom=0)
plt.title("Entry Corridor")
