...
event_dict ={
    ...
    "e17_s" : qc.event("Natural frequency oscillation",0.02,"LOC",count= 1),
    ...
    "e5_gnc" : qc.event("Accelerometer failure",0.02,"LOC",count = 4,redundancy = 3),
    ...
    "e10_gnc" : qc.event("Critical thruster failure:",0.02,"LOV",count = 32,redundancy = 2),
    ...
    "e2_ab" : qc.event("Abort engine failure",0.1,"LOC",count = 1),
    "e3_ab" : qc.event("Suicide burn starting too early or late",0.1,"LOC",count = 1),
    "e4_ab" : qc.event("Too high load",0.1,"LOV",count = 1),
    "e5_ab" : qc.event("Parachute deployment failure",0.1,"LOC",count = 2, redundancy=1),
