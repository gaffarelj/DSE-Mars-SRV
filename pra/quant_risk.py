...
event_dict ={
    ...
    "e9_s" : qc.event("Legs not deploying",1.67e-3,"LOV",count=8, redundancy=4),
    ...
    "e3_gnc" : qc.event("Star tracker failure",8.04e-5,"LOC",count = 3,redundancy = 2),
    ...
    "e6_gnc" : qc.event("Flight computer failure",7.41e-4,"LOC",count = 2,redundancy = 1),
    "e7_gnc" : qc.event("RCS Thruster failure",4.00e-3,"LOV",count = 32,redundancy = 6),
    "e8_gnc" : qc.event("Ignition failure",2.27e-5,"LOM",count = 1,redundancy = 0),
    ...
    "e12_gnc" : qc.event("Control algorithm errors",3.71e-5,"LOC",count = 1),
    ...
    "e5_com" : qc.event("No line of sight post abort landing",5.00e-2,"LOM",count = 1),
	...
	"e1_ab" : qc.event("Failure to detect need to abort",5.00e-2,"LOC",count = 1),
    "e2_ab" : qc.event("Abort engine failure",1.09e-3,"LOM",count = 1),
    ...
    "e5_ab" : qc.event("Parachute deployment failure",4.00e-3,"LOM",count = 2, redundancy=1),
