...
event_dict ={
    ...
    "e9_s" : qc.event("Legs not deploying",0.02,"LOV",count= 4, redundancy=1),
	...
	"e1_com" : qc.event("Poor or no line of sight",0.02,"LOM",count = 1),
    ...
    "e4_com" : qc.event("Extensive noise from cross-link",0.02,"LOM",count = 1),
    ...
    "e2_ls" : qc.event("Capsule failure",0.1,"LOM",count = 1),
    ...
    "e2_comp" : qc.event("Critical software erros",0.1,"LOV",count = 1),
    "e3_comp" : qc.event("Sudden processing erros",0.1,"LOM",count = 1),
