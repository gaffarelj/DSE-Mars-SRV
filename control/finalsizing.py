...
reentry_mp, reentry_mp_rot, reentry_mp_pitch, reentry_RCS_rot, reentry_RCS_pitch, reentry_t_rot = rty.reentry_control(I_reentry,cg_reentry, tburn_reentry, reentry_RCS_rot, Isp)
...
ascent_mp, ascent_mp_rot, ascent_mp_pitch, ascent_RCS_rot, ascent_RCS_pitch, ascent_t_rot =asc.ascent_control(I_ascent,cg_ascent, tburn_ascent, ascent_RCS_rot, Isp)
...
RV_mp, RV_mp_rot, RV_mp_docking, RV_RCS_rot, RV_RCS_docking, RV_t_rot = rvs.RV_Docking_control(I_RV,cg_RV,tburn_RV_rot,tburn_RV_deltaV,Isp,m0,error)
